...
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows, decorations.text}
...
\include{chapters/chapter5/main} % rename as required (but remember to update directories appropriately)
