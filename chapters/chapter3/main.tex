...
This chapter presents a simple foraging algorithm called na\"ive foraging which will form the benchmark algorithm for the experiments and presents two novel swarm robotics foraging algorithms inspired by the foraging behaviour of desert ants and honey bees. Each of these algorithms have differing capabilities when it comes to memory, communication, division of labour and navigation. The benchmark algorithm is presented in Section~\ref{naiveforaging} and Section~\ref{desertantforaging} introduces the novel foraging algorithm based on desert ants. Section~\ref{honeybeeforaging} dictates a novel foraging algorithm inspired by honey bees and the algorithms are summarized in Section~\ref{prioritized:summary}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
