...
The desert ant, honey-bee and na\"ive foraging algorithms were compared for various robot configurations over different environments. The experiment and parameters were defined in Chapter~\ref{chap:third}. In order to compare two experiments, two one-tailed Wilcoxin tests were performed. 
