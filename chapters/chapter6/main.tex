...
The desert ant, honey-bee and na\"ive foraging algorithms were compared for various robot configurations over various environments. An experiment was defined in Chapter~\ref{chap:third}. In order to compare two experiments, two one-tailed Wilcoxin tests were performed. The first test determines if the performance measures for each sample of experiment A are distributed greater than the performance measures for each sample of experiment B. If experiment A is greater than experiment B, then a win is counted for experiment A. The second test determines if the performance of samples in experiment A are less than the performance of samples in experiment B. If experiment A performs less than experiment B, a loss is counted for experiment A. 
