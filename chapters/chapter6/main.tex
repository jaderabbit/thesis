...
\begin{itemize}
\item The robots correctly increase  manage to successfully forage the entire environment and thus addition of robots makes no difference. TODO: This statement is invalid. 
\item The addition of more robots creates interference between the robots or causes malfunction within the algorithms thus impacting scalability. 
\end{itemize}
