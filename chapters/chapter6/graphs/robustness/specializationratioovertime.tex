...
\begin{picture}(7200.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(3849,140){\makebox(0,0){\strut{}time steps}}%
      \put(5936,4276){\makebox(0,0)[r]{\strut{}Specialization Ratio $\tau$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{chapters/chapter6/graphs/robustness/specializationratioovertime}}%
    \gplfronttext
  \end{picture}%
\endgroup
