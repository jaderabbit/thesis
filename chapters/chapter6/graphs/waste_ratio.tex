...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(3940,154){\makebox(0,0){\strut{}Environment ratio ($r$)}}%
      \put(3940,4709){\makebox(0,0){\strut{}Non-prioritized items over time $\mu$ for each algorithm over environment ratio $r$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{chapters/chapter6/graphs/waste_ratio}}%
    \gplfronttext
  \end{picture}%
\endgroup
