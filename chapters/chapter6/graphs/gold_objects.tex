...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4006,4709){\makebox(0,0){\strut{}Prioritized items over time for each algorithm over object percentages}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{chapters/chapter6/graphs/gold_objects}}%
    \gplfronttext
  \end{picture}%
\endgroup
