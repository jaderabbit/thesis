...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(3940,4709){\makebox(0,0){\strut{}Prioritized items over time ($\sigma$) for each algorithm over environment ratio $r$}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{chapters/chapter6/graphs/gold_ratio}}%
    \gplfronttext
  \end{picture}%
\endgroup
