...
The swarm size scalability study will only consider large environments (.i.e. $S=500$) to avoid the possibility that an environment runs out of items to forage.
