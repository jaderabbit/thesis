...
Similarly, define the list of all considered values for problem size, $p$, as $\overline{p}$ with length $n_p$. The smallest probem size is $p_{min}$ and $E_{p_i}$ is the average foraging efficiency over all experiments, with problem size $p_i$.
