...
%TODO: Expand to include more references to SI techniques.

%Hard to separate into Biology & Application. 
...
%TODO: Add diagram for path integration
...
%TODO: Biology 	-> Discuss pheromones more. 
%				-> Explain dead reckoning.
%				-> Landmark location - using the sun. 

\subsection{Honey bee}
%TODO: Add references for honey bee stuff
%Intro
...
%TODO: Discussion about the taxonomy. 
