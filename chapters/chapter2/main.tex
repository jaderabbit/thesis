...
\item In order to get to the sink, a number of homing techniques exist. An example of a homing technique is beacon homing, where the robot first changes their direction to face a beacon at the sink, and then move towards the beacon, following a trail or odometry \cite{winfield2009towards}.
