...
%TODO: 
\begin{itemize}
	\item \textbf{Subsumption} - the invention of subsumption architecture almost promoted the development of swarm robotics by simplifying the process of building robots. Each behaviour forms a separate module that can inhibit other behaviours. Discussed in more detail in section %TODO - cite label
...
\begin{itemize}
	...
	In swarm robotics techniques, neural networks are used 
\end{itemize}	
